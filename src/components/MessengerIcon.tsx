  ...
  return (
    ...
    >
      ...
      <g>
        <path
          fill="#fff"
          d="M30.3,78L46,53.5c3.3-5.1,10.3-6.2,14.9-2.3l10.4,8.7c1.3,1.1,3.2,1.1,4.5,0l16.7-13.3c2.5-2,5.8,1,4.2,3.7 l-15,24.4c-3.6,5.8-11.6,7-16.7,2.3l-9-8.3c-1.3-1.2-3.4-1.3-4.8-0.1L35.2,82.3C32.3,84.8,28.3,81.2,30.3,78z"
        ></path>
      </g>
    </svg>
  );
